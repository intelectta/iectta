...
export default function UserAdmin() {
  ...
  const deleteUser = async (id) => {
    ...
    // refresh list
    const refreshed = await db.users.toArray();
    // we have to update the context manually because AuthContext doesn't watch deletions
    // (simple way: just reload the page – works for demo)
